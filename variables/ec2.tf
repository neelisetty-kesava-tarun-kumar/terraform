...
resource "aws_instance" "example" {
  ...
  instance_type = var.instance_type #The key words(like:- instance_type) cannot be changed but the values(like:- "t3.micro") can be changed according to the user reuirements.
